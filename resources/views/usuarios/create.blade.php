...
<script>
 $(document).ready(function () {
    ...
    $('#name, #apellido').on('input', function () {
        validarTexto(this);
    });
    ...
    let password = $(this).val(); // Obtener el valor real de la contraseña
    ...
    if (length >= 8 && length <= 40) { 
        ...
        $(this).addClass('is-invalid').removeClass('is-valid');
        $(this).next('.invalid-feedback').text('La contraseña debe tener entre 8 y 40 caracteres');
    }
