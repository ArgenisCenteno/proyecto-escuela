<form action="{{ route('pacienteTratamientos.update', $pacienteTratamiento->id) }}" method="POST" id="pacienteTratamientoForm">
    @csrf
        ...
        <div class="form-group col-md-6">
            ...
            <select name="paciente_id" id="paciente_id" class="form-control" required>
                ...
                @foreach($pacientes as $paciente)
                    <option value="{{ $paciente->id }}" {{ $pacienteTratamiento->paciente_id == $paciente->id ? 'selected' : '' }}>
                        {{ $paciente->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group col-md-6">
            ...
            <select name="tratamiento_id" id="tratamiento_id" class="form-control" required>
                ...
                @foreach($tratamientos as $tratamiento)
                    <option value="{{ $tratamiento->id }}" {{ $pacienteTratamiento->tratamiento_id == $tratamiento->id ? 'selected' : '' }}>
                        {{ $tratamiento->nombre }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <select name="especialista_id" id="especialista_id" class="form-control" required>
                ...
                @foreach($especialistas as $especialista)
                    <option value="{{ $especialista->id }}" {{ $pacienteTratamiento->especialista_id == $especialista->id ? 'selected' : '' }}>
                        {{ $especialista->nombre }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" required value="{{ $pacienteTratamiento->fecha_inicio }}">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" value="{{ $pacienteTratamiento->fecha_fin }}">
        ...
        <div class="form-group col-md-6">
            ...
            <textarea name="observaciones" id="observaciones" class="form-control" rows="4">{{ $pacienteTratamiento->observaciones }}</textarea>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <select name="estatus" id="estatus" class="form-control" required>
                <option value="En proceso" {{ $pacienteTratamiento->estatus == 'En proceso' ? 'selected' : '' }}>En proceso</option>
                <option value="Cancelado" {{ $pacienteTratamiento->estatus == 'Cancelado' ? 'selected' : '' }}>Cancelado</option>
                <option value="Completado" {{ $pacienteTratamiento->estatus == 'Completado' ? 'selected' : '' }}>Completado</option>
            </select>
...
<script>
    $(document).ready(function () {
        ...
        function validateDates() {
            ...
            return true; // Return true if there's no fechaFin to validate
        }
